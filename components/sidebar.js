  ...
  return (
    <div className="sidebar">
      <div className="sidebar-menus">
        <ul>
          {sideOptions.map(({ text }, i) => (
            <li
              class={optionHovered === i ? "hovered" : ""}
              onMouseEnter={() => setOptionHovered(i)}
            ...
            >
              <motion.div
                ...
                initial={{ scaleX: 0 }}
                animate={{
                  scaleX: optionHovered === i ? 1 : 0,
                  transformOrigin:
                    optionHovered === i ? "bottom left" : "bottom right",
                }}
        ...
        <div className="social-links">
          <motion.svg
            ...
            viewBox="0 0 24 24"
            aria-hidden="true"
            onMouseEnter={() => setSocialHovered("instagram")}
            onMouseLeave={() => setSocialHovered(null)}
            animate={{ translateY: socialHovered === "instagram" ? -5 : 0 }}
          >
            <path
              fill-rule="evenodd"
          ...
          <motion.svg
            ...
            viewBox="0 0 24 24"
            aria-hidden="true"
            onMouseEnter={() => setSocialHovered("facebook")}
            onMouseLeave={() => setSocialHovered(null)}
            animate={{ translateY: socialHovered === "facebook" ? -5 : 0 }}
          >
            <path
              fill-rule="evenodd"
          ...
          <motion.svg
            ...
            viewBox="0 0 24 24"
            aria-hidden="true"
            onMouseEnter={() => setSocialHovered("twitter")}
            onMouseLeave={() => setSocialHovered(null)}
            animate={{ translateY: socialHovered === "twitter" ? -5 : 0 }}
          >
